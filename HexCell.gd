...
var cube_coords = Vector3(0, 0, 0): get = get_cube_coords, set = set_cube_coords
# but other coord systems can be used
var axial_coords : get = get_axial_coords, set = set_axial_coords
var offset_coords : get = get_offset_coords, set = set_offset_coords
